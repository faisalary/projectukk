...
(function ($) {
    ...
    $.fn.pdfViewer = function (url, options) {
        ...
        $(this).append('<div class="pdf-toolbar d-flex justify-content-start align-items-center">' +
            '<a class="mx-1 btn btn-sm btn-icon rounded-pill btn-primary text-white" id="btn-print" title="Print"><i class="ti ti-printer ti-xs"></i></a>' +
            '<a class="mx-1 btn btn-sm btn-icon rounded-pill btn-primary text-white" id="btn-download" title="Download"><i class="ti ti-download ti-xs"></i></a>' +
            '<a class="mx-1 btn btn-sm btn-icon rounded-pill btn-primary text-white" id="btn-first" title="First Page"><i class="ti ti-chevrons-left ti-xs"></i></a>' +
            '<a class="mx-1 btn btn-sm btn-icon rounded-pill btn-primary text-white" id="btn-prev" title="Previous Page"><i class="ti ti-chevron-left ti-xs"></i></a>' +
            '<a class="mx-1 btn btn-sm btn-icon rounded-pill btn-primary text-white" id="btn-next" title="Next Page"><i class="ti ti-chevron-right ti-xs"></i></a>' +
            '<a class="mx-1 btn btn-sm btn-icon rounded-pill btn-primary text-white" id="btn-last" title="Last Page"><i class="ti ti-chevrons-right ti-xs"></i></a>' +
            // '<input type="number" placeholder="0" id="current-page">' +
            '<span id="current-page">1</span>&ensp;' +
            '<span id="page-number-sep">of</span>&ensp;' +
            ...
            // '<a class="mx-1 btn btn-sm btn-icon rounded-pill btn-primary text-white" id="btn-zoom-in" title="Zoom In"><i class="ti ti-plus ti-xs"></i></a>' +
            // '<a class="mx-1 btn btn-sm btn-icon rounded-pill btn-primary text-white" id="btn-zoom-out" title="Zoom Out"><i class="ti ti-minus ti-xs"></i></a>' +
            '</div>');
        ...
        const renderPages = () => {
            $('#current-page').text(initialState.currentPage);
        ...
        $('a#btn-first').on('click', function (e) {
            showFirstPage();
        });
        ...
        $('a#btn-last').on('click', function (e) {
            showLastPage();
        });
        //Zoom functionalities
        $('a#btn-zoom-in').on('click', function (e) {
            zoomIn();
        });
        $('a#btn-zoom-out').on('click', function (e) {
            zoomOut();
        });
        ...
        $('#page-container').on('scroll', function (e) {
            ...
            const pageHeight = $('#page-1').height() - 50;//The page height + top margin
