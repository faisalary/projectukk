<div class="content">
    <h5>Nilai Pembimbing Lapangan</h5>
    <div id="container_result_nilai_lap" class="table-responsive border border-bottom-0 mt-4"></div>
    ...
    <div class="d-flex justify-content-between mt-5">
        ...
        <button class="btn btn-primary button-next" type="button" data-step="{{ Crypt::encryptString("2") }}">Simpan</button>
    </div>
</div>