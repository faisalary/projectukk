                    ...
                    <!-- @yield('conten') -->
                        <div class="card text-center" style="width: 450px;">
                            ...
                            <div class="text-start ps-5 pe-5">
                                ...
                                <div class="mb-3">
                                    <label for="defaultFormControlInput" class="form-label">Kata sandi <span style="color: red;">*</span> </label>
                                    <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Kata sandi" aria-describedby="defaultFormControlHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="defaultFormControlInput" class="form-label">Konfirmasi Kata sandi <span style="color: red;">*</span> </label>
                                    <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Konfirmasi Kata sandi" aria-describedby="defaultFormControlHelp">
                                </div>
