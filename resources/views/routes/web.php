...
Route::group(
    ...
    function () {
        ...
        // Route::post('/job/{slug}/apply', 'FrontJobsController@jobApply')->name('jobApply');
        ...
        // Route::get('sw/{sw}', ['as' => 'sw.switch', 'uses' => 'App\Http\Controllers\PageSwitcherController@switchPage']);
        // Route::get('/bg-img', 'crud@index')->name('bgImage');
        // Route::get('/country', 'FrontJobsController@country')->name('country');
        // Route::get('/job-apply', 'FrontJobsController@jobsApply')->name('jobApply');
        // Route::get('/coba', 'FrontJobsController@coba');
    }
);
