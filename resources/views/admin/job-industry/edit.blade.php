                        ...
                        <div class="col-sm-9 nopadding">
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" name="name" value="{{ $industry->name }}" class="form-control" placeholder="@lang('menu.jobIndustries') @lang('app.name')">
...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('admin.job-industries.update', $industry->id)}}',
