            ...
            <div class="card">
                <div class="card-header d-flex p-0 ui-sortable-handle">
                    <h3 class="card-title p-3">
                        <i class="fa fa-file mr-2"></i> @lang('modules.interviewSchedule.interviewSchedule')
                    </h3>
                </div><!-- /.card-header -->
    ...
    <script>
        ...
        taskEvents = [
                @foreach($schedules as $schedule)
            {
                ...
                title: '{{ $schedule->jobApplication->job->title }} on {{ $schedule->jobApplication->user->name }}',
            ...
            $.easyAjax({
                ...
                success: function (response) {
                    ...
                    response.scheduleData.forEach(function(schedule){
                        const taskEvent = {
                            id: schedule.id,
                            title: schedule.job_application.job.title +' on '+  schedule.job_application.user.name ,
                            start: schedule.schedule_date ,
                            end: schedule.schedule_date,
                        };
