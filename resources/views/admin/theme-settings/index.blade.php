                ...
                <div class="card">
                    <div class="card-body">
                         <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <h5 class="box-title">@lang('modules.themeSettings.footerSiteCustomCss')</h5>
                                <textarea name="footer_custom_css" class="my-code-area" rows="20" style="width: 100%">@if(is_null($adminTheme->footer_custom_css))/*Enter your custom css after this line*/@else {!! $adminTheme->footer_custom_css !!} @endif</textarea>
