...
<div class="row b-b">
    @if($section_visibility['resume'] == 'yes')
        ...
        <div class="col-md-8 pb-4 pt-4 b-b">
            <div class="form-group">
                <input class="select-file" accept=".pdf,.doc,.docx" type="file"
                    name="resume"><br>
    ...
    @if($section_visibility['cover_letter'] == 'yes')
        ...
        <div class="col-md-8 pt-4 b-b">
            ...
            <div class="form-group">
                <textarea class="form-control" name="cover_letter" rows="4">{{ !empty($application) ? $application->cover_letter : '' }}</textarea>
            </div>
        </div>
    @endif
</div>