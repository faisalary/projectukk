                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{ $application->user->name }}" name="full_name" placeholder="@lang('app.name')">
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label">@lang('app.gradYear')</label>
                                    <input class="form-control" type="number" name="grad_year" value="{{ $application->grad_year }}"
                                           placeholder="@lang('app.gradYear')">
                                </div>

                                <div class="form-group">
                                    <label class="control-label">@lang('app.gpa')</label>
                                    <input class="form-control" type="number" min="0" max="4" step="0.01" name="gpa" value="{{ $application->gpa }}"
                                           placeholder="@lang('app.gpa')">
                                </div>

                                <label class="control-label">@lang('modules.front.maritalStat')</label>
                                <div class="form-group">
                                    <div class="form-inline">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="marital_stat" id="Single" value="Single" @if($application->marital_stat == 'Single') checked @endif />
                                            <label class="form-check-label" for="Single">Single</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="marital_stat" id="Married" value="Married" @if($application->marital_stat == 'Married') checked @endif />
