                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{-- <input type="number" id="currency" class="form-control" min="0" name="salary" value=""> --}}
                                        <input type="text" id="currency" class="form-control number-separator" name="salary" value="">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
...
<script src="{{ asset('assets/node_modules/jquery/easy-number-separator.js') }}"></script>
...
<script>
    ...
    new AutoNumeric('#currency', { currencySymbol :''})
