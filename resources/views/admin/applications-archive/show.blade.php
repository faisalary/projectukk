...
<div class="r-panel-body p-3">
    ...
    <div class="row font-12">
        <div class="col-4">
            <img src="{{ $application->user->profile_image_url }}" class="img-circle img-fluid">
        ...
        <div class="col-8 right-panel-box">
            <div class="col-sm-12">
                ...
                <p class="text-muted">{{ ucwords($application->user->name) }}</p>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <p class="text-muted">{{ $application->user->calling_code.$application->user->mobile }}</p>
            </div>
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-12 col-md-4">
                        ...
                        <p class="text-muted" id="gender-{{ $application->id }}">{{ ucfirst($application->user->gender) }}</p>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <strong>@lang('app.dob')</strong><br>
                        <p class="text-muted" id="dob-{{ $application->id }}">{{ $application->dob }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="row">
                    {{-- <div class="col-sm-12 col-md-4">
                        <strong>@lang('app.gradYear')</strong><br>
                        <p class="text-muted">{{ $application->grad_year }}</p>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <strong>@lang('app.gpa')</strong><br>
                        <p class="text-muted">{{ $application->gpa }}</p>
                    </div> --}}
                </div>
            </div>

            <div class="col-sm-12">
                <strong>@lang('app.marStat')</strong><br>
                <p class="text-muted">{{ $application->marital_stat }}</p>
            </div>
            ...
            <div class="col-12" id="skills-container">
                ...
                <div class="form-group mb-2">
                    <select name="skills[]" id="skills" class="form-control select2 custom-select" multiple>
                        @forelse ($application->skills()->get() as $skill)
