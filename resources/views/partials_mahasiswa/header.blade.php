                                ...
                                <ul class="menu-inner">
                                    ...
                                    <li class="menu-item">
                                        ...
                                        <ul class="menu-sub">
                                            ...
                                            <li class="menu-item">
                                                <a href="javascript:void(0)" class="menu-link">
                                                    <div data-i18n="Persetujuan Dosen Wali">Persetujuan Dosen Wali
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="menu-item">
                                            ...
                                            <li class="menu-item">
                                                <a href="javascript:void(0)" class="menu-link">
                                                    <div data-i18n="Input Dokumen Magang Mandiri">Input Dokumen Magang
                                                        Mandiri</div>
                                                </a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="javascript:void(0)" class="menu-link">
                                                    <div data-i18n="Input Dokumen Magang Kerja">Input Dokumen Magang
                                                        Kerja</div>
                                                </a>
                                            </li>
                        ...
                        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                            ...
                            <a href="{{ route('login') }}">
                                <button class="btn btn-outline-success me-2"
                                    style="margin-left:50px; border-radius: 8px;" type="button">Masuk</button>
                            </a>
                                    ...
                                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-online me-2">
                                                <img src="../../app-assets/img/avatars/1.png" alt="Avatar"
                                                    class="h-auto rounded-circle" />
                                            </div>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal" target="_blank">
