                ...
                <form id="wizard-validation-form" onSubmit="return false">
                    ...
                    <div id="personal-info-validation" class="content">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12 col-sm-6">
                                <label for="tahapan" class="form-label" id="tahapan" name="tahapan">Jenis
                                    kelamin<span class="text-danger">*</span></label>
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="tahapan" class="form-check-input" type="radio" value="0" />
                                        <label class="form-check-label" for="tahapan">Laki-Laki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="tahapan" class="form-check-input" type="radio" value="1" />
                                        <label class="form-check-label" for="tahapan">Perempuan</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="tahapan" class="form-check-input " type="radio" value="2" />
                                        <label class="form-check-label" for="tahapan">Laki-Laki & Perempuan</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-sm-6">
                            ...
                            <div class="col-lg-12 col-sm-6">
                                <label for="tahapan" class="form-label" id="tahapan" name="tahapan">tahapan
                                    Magang<span class="text-danger">*</span></label>
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="tahapan" class="form-check-input" type="radio" value="0" />
                            ...
                            <div class="col-lg-12 col-sm-6">
                                ...
                                <div class="col mt-2">
                                    <div class="form-check form-check-inline">
                                        <input name="tahapan" class="form-check-input" type="radio" value="0" />
                                        <label class="form-check-label" for="tahapan">Online</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="tahapan" class="form-check-input" type="radio" value="1" />
                                        <label class="form-check-label" for="tahapan">Onsite</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="tahapan" class="form-check-input " type="radio" value="2" />
                                        <label class="form-check-label" for="tahapan">Hybird</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-sm-6">
