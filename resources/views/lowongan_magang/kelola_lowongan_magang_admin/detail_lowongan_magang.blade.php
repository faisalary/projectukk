...
<div class="d-flex">
    <div class="card" style="padding: 50px 30px; width: 100%; margin-right: 20px; !important">
        ...
        <div class="mt-4" style="border-bottom: 1px solid #D3D6DB;">
            ...
            <ul style="list-style-type: disc; padding-left: 20px; margin-top: 5px; padding-bottom: 30px; font-size: 15px; color: #23314B;">
    ...
    <div style="width: 25%">
        <div class="card" style=" height: fit-content; padding: 24px;">
            <button type="button" data-bs-toggle='modal' data-bs-target='#acceptModal' class="btn btn-success w-100" style="font-size: 15px; box-shadow: 0 2px 4px rgba(75, 70, 92, 0.1);">
                <i class="ti ti-check ti-sm" style="margin-right: 10px"></i>
                Setujui
            </button> <button type="button" data-bs-toggle='modal' data-bs-target='#rejectModal' class="btn btn-danger w-100 mt-3" style="font-size: 15px; box-shadow: 0 2px 4px rgba(75, 70, 92, 0.1);">
        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                <span class="text-warning">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-alert-triangle" width="75" height="67" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
