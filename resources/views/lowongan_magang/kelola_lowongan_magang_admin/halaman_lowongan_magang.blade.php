                ...
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class="nav-link active showSingle" target="1" role="tab"
                        ...
                        <span class="badge rounded-pill badge-center h-px-20 w-px-20 ms-1"
                            style="background-color: #DCEEE3; color: #4EA971;">{{ $lowonganmagang['total'] }}</span>
                    </button>
                </li>
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class="nav-link showSingle" target="2" role="tab" data-bs-toggle="tab"
                        ...
                        <span class="badge rounded-pill badge-center h-px-20 w-px-20 ms-1"
                            style="background-color: #DCEEE3; color: #4EA971;">{{ $lowonganmagang['tertunda'] }}</span>
                    </button>
                </li>
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class="nav-link showSingle" target="3" role="tab" data-bs-toggle="tab"
                        ...
                        <span class="badge rounded-pill badge-center h-px-20 w-px-20 ms-1"
                            style="background-color: #DCEEE3; color: #4EA971;">{{ $lowonganmagang['diterima'] }}</span>
                    </button>
                </li>
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class="nav-link showSingle" target="4" role="tab" data-bs-toggle="tab"
                        ...
                        <span class="badge rounded-pill badge-center h-px-20 w-px-20 ms-1"
                            style="background-color: #DCEEE3; color: #4EA971;">{{ $lowonganmagang['ditolak'] }}</span>
                    </button>
                </li>
            </ul>
        </div>
