    ...
    <div class="authentication-wrapper authentication-cover authentication-bg" style="background-image: url({{asset('assets/images/background/Bg-Green.svg')}}); background-repeat: no-repeat; background-size: cover;  padding-bottom: 1rem;">
      <div class="authentication-inner text-center">
        <div class="text-center">
          <h3 class="mb-1 fw-bold">Silahkan hubungi LKM untuk memperbarui password</h3>
          <p class="mb-4 text-secondary" style="font-size: 18px; text-color: black;">
            <a href="https://wa.me/6285161415115" target="_blank" class="text-primary">Hubungi LKM</a>
          </p>
          <a href="{{ url('/login') }}" class="btn btn-primary"><i class="ti ti-arrow-left"></i> Halaman Login</a>
        </div>
        <img alt="auth-login-cover" class="img-fluid my-5" style="width: 25%;" src="{{ asset('assets/images/background/auth_new.png') }}" alt="Login" />
      </div>
    </div>
</body>
</html>
