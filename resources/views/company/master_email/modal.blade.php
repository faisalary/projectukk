        ...
        <div class="modal-content">
            ...
            <form class="default-form" method="POST" action="{{ route('master_email.store') }}"
                ...
                <div class="modal-body pt-2">
                    <div class="row">
                        <div class="col mb-2 form-input">
                            ...
                            <input type="text" class="form-control" placeholder="Subjek Email"
                                aria-describedby="defaultFormControlHelp" name="subject_email">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-2 form-input">
                            ...
                            <input type="text" class="form-control" placeholder="Headline Email"
                                aria-describedby="defaultFormControlHelp" name="headline_email">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-2">
                            <label for="content" class="form-label">Konten</label>
                            <textarea class="form-control" placeholder="Konten Email" id="content" name="content_email" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="card-subtitle text-muted mb-3">Tipe File: .pdf, .xlsx, .png. Maximum upload file size :
                        2 MB.</div>
                    <div class="card-link">
