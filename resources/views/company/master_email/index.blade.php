...
<div class="row cnt">
    <div class="col-8 text-secondary mb-3">Informasi pembuatan template : <i class='tf-icons ti ti-alert-circle text-primary pb-1' data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Buatlah template undangan sebanyak jumlah tahap yang ada!" id="tooltip-filter"></i></div>
</div>
