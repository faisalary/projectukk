        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-end">
                <button class="btn btn-success waves-effect waves-light"
                    data-bs-target="" style="min-width: 200px;"><i class="tf-icons ti ti-download me-2"></i><span class="mt-1">Unduh CV</span>
                </button>
            </div>
        </div>
        <div class="mb-3">
            <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                    <img src="../../app-assets/img/avatars/2.png" alt="user image"
                        class="d-block ms-0 mt-4  rounded user-profile-img" />
                </div>
                <div class="flex-grow-1 mt-0 mt-4">
                    <div
                        class="d-flex align-items-end align-items-sm-start ms-3 flex-md-row flex-column gap-4">
                        <div class="me-2 ms-1">
                            <h1 class="mb-2">Cecilia Payne</h1>
                            <p class="text" style="font-size: 20px">UI/UX Designer</p>
                        </div>
                        <div class="ms-auto">
                            ...
                            <button class="rounded-circle btn-label-success btn-icon btn-sm waves-effect me-2"
                                style="min-width: 40px; height:40px;">
