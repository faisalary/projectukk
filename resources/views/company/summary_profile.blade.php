            ...
            <div class="card-body">
                <div class="d-flex justify-content-between border-bottom">
                    ...
                    <div class="col-md-2 col-12 text-end">
                        <i class="menu-icon tf-icons ti ti-edit text-success" data-bs-toggle="modal" data-bs-target="#modalEditProfile"></i>
                    </div>
                </div>
                <div class="row mt-5">
                <div class="col-md-5 col-12 border-end">
                    <div class="user-avatar-section">
                        <div class="d-flex align-items-center flex-column">
                          <img class="rounded-circle w-px100 mb-3 pt-1 mt-4" src="../../app-assets/img/avatars/15.png" height="125" width="125" alt="User avatar"/>
                ...
                <div class="col-7">
                    <div class="row">
                        ...
                        <div class="col-11 p-0">
                            <p>Jl. Mars Sel. X No.19B, Manjahlega, Kec. Rancasari, Kota Bandung, Jawa<br> Barat 40286</p>
                        </div>
                        ...
                        <div class="col-11 p-0">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam dapibus ligula sit amet massa scelerisque, eget vehicula dui vestibulum. Etiam vitae orci rhoncus, pulvinar lectus et, dignissim lorem. </p>
                        </div>
