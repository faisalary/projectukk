<div class="content">
    ...
    <div class="row g-3">
        @for ($i = 0; $i < ($tahap + 1); $i++)
            <div class="{{ ($i == 1 && $i != ($tahap + 1)) ? 'border-bottom' : ''  }}">
                <div class="mb-4">
                    <input type="hidden" name="proses_seleksi[{{ $i }}][seleksitahap]" value="{{ Crypt::encryptString(($i+1)) }}">
                    ...
                    <div class="form-group col-lg-12 mt-3">
                        ...
                        <textarea class="form-control" rows="2" id="deskripsiseleksi{{ $i }}" name="proses_seleksi[{{ $i }}][deskripsiseleksi]" placeholder="Masukan Deskripsi Tahapan"></textarea>
                    ...
                    <div class="col-lg-12 col-sm-6 mt-3">
                        <div class="d-flex justify-content-center">
                            <div class="form-group me-4" style="flex: 1;">
                                ...
                                <input class="form-control flatpickr-date" type="text" id="mulai{{ $i }}" name="proses_seleksi[{{ $i }}][mulai]" placeholder="YYYY-MM-DD" readonly="readonly">
                                <div class="invalid-feedback"></div>
                            </div>
                            ...
                            <div class="form-group ms-4" style="flex: 1;">
                                ...
                                <input class="form-control flatpickr-date" type="text" id="akhir{{ $i }}" name="proses_seleksi[{{ $i }}][akhir]" placeholder="YYYY-MM-DD" readonly="readonly">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
