...
@section('main')
    ...
    <div class="col-xl-12">
            ...
            <ul class="nav nav-pills mb-3 " role="tablist">
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class="nav-link active showSingle" target="1" role="tab"
                        data-bs-toggle="tab" data-bs-target="#navs-pills-justified-kandidat"
                        aria-controls="navs-pills-justified-kandidat" aria-selected="true" style="padding: 8px 9px;">
                        ...
                        <span class="badge rounded-pill badge-center h-px-20 w-px-20 ms-1"
                            style="background-color: #DCEEE3; color: #4EA971;">3</span>
                    </button>
                </li>
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class="nav-link showSingle" target="3" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-justified-belum-proses"
                        aria-controls="navs-pills-justified-belum-proses" aria-selected="false" style="padding: 8px 9px;">
                ...
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class=" nav-link showSingle" target="2" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-justified-screening" aria-controls="navs-pills-justified-screening"
                ...
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class="nav-link showSingle" target="2" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-justified-tahap1" aria-controls="navs-pills-justified-tahap1"
                        aria-selected="false" style="padding: 8px 9px;">
                ...
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class="nav-link showSingle" target="2" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-justified-tahap2" aria-controls="navs-pills-justified-tahap2"
                        aria-selected="false" style="padding: 8px 9px;">
                ...
                <li class="nav-item" style="font-size: small;">
                    <button type="button" class="nav-link showSingle" target="2" role="tab"
                        data-bs-toggle="tab" data-bs-target="#navs-pills-justified-penawaran"
                        aria-controls="navs-pills-justified-penawaran" aria-selected="false" style="padding: 8px 9px;">
        ...
        <div class="row cnt">
            <div class="col-8 text-secondary mb-3">Filter Berdasarkan : <i
                    class='tf-icons ti ti-alert-circle text-primary pb-1' data-bs-toggle="tooltip"
                    data-bs-placement="right"
                    data-bs-original-title="Program Studi : D3 Rekayasa Perangkat Lunak Aplikasi, Fakultas : Ilmu Terapan, Universitas : Tel-U Jakarta, Status :  Diterima"
            ...
            <div id="div2" class="col-1 targetDiv" style="display: none;">
                <div class="col-md-4 col-12 mb-3 d-flex align-items-center justify-content-between">
                    ...
                    <button class="btn btn-success waves-effect waves-light" data-bs-toggle="offcanvas"
                        data-bs-target="#modalSlide" style="min-width: 142px;"><i class="tf-icons ti ti-checks">
                            Terapkan</i>
                    </button>
                </div>
            </div>
                            ...
                            <div id="div1" class="targetDiv">
                                <div class="col mb-2 form-input">
                                    ...
                                    <select class="form-select select2" id="status" name="status"
                                        data-placeholder="Status Kandidat">
                ...
                <div class="card">
                    <div class="row mt-3 ms-2">
                        <div class="col-6 d-flex align-items-center"
                            style="border: 2px solid #D3D6DB; width:550px; height:40px;border-radius:8px;">
                            <span style="color:#4B465C;">Total Kandidat Belum Proses Fullstack Developer :</span>
                            &nbsp;<span style="color:#7367F0;">350</span> &nbsp;<span style="color:#4EA971;">Kandidat
                                Melamar</span>
                        </div>
                        <div class="col-6 d-flex align-items-center justify-content-end ms-4">
                            <span style="color:#4B465C;">Batas Konfirmasi Penerimaan :</span>&nbsp;<span
                                style="color:#4EA971;">20 Juli 2023</span>
                        </div>
                    </div>
            ...
            <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
                <div class="row">
                    <div class="col-12 d-flex justify-content-end">
                        <button class="btn btn-success waves-effect waves-light" data-bs-toggle="offcanvas"
                            data-bs-target="" style="min-width: 220px;"><i class="tf-icons ti ti-file-symlink"> Unduh
                                Format CV</i>
                        </button>
                        <select class="select2 form-select" data-placeholder="Ubah Status Kandidat">
                ...
                <div class="mb-3">
                    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            <img src="../../app-assets/img/avatars/2.png" alt="user image"
                                class="d-block h-auto ms-0 ms-sm-4 mt-4  rounded user-profile-img" />
                        </div>
                        <div class="flex-grow-1 mt-0 mt-sm-5">
                            <div
                                class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start ms-3 flex-md-row flex-column gap-4">
                                <div class="me-2 ms-1">
                                    <h4 class="mb-0">Cecilia Payne</h4>
                                    <large class="text">UI UX Designer</large>
                                </div>
                                <div class="ms-auto">
                                    <button class="rounded-circle btn-label-success btn-icon btn-sm waves-effect"
                ...
                <p class="cursor-pointer">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                    Ipsum has been the industry's standard dummy text ever since the 1500s, when an <span
                        id="dots">...</span><span id="more"> unknown printer took a galley of type and scrambled
                    ...
                    <ul class="timeline ms-1 mb-0">
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="row">
                                ...
                                <h6>Deskripsi</h6>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque iaculis lacinia
                                    erat in auctor. In venenatis nisl vel nisl laoreet, in feugiat nibh tincidunt. Donec
                                    fermentum interdum nunc, ac viverra tellus molestie in.</p>
                            </div>
