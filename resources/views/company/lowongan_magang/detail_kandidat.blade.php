        ...
        <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
            <div class="row">
                <div class="col-12 d-flex justify-content-end">
                    <button class="btn btn-success waves-effect waves-light" data-bs-toggle="offcanvas" data-bs-target="" style="min-width: 220px;"><i class="tf-icons ti ti-file-symlink"> Unduh
                            Format CV</i>
                    </button>
                    <select class="select2 form-select" data-placeholder="Ubah Status Kandidat">
            ...
            <p class="cursor-pointer">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                Ipsum has been the industry's standard dummy text ever since the 1500s, when an <span id="dots">...</span><span id="more"> unknown printer took a galley of type and scrambled
                    ...
                    publishing software like Aldus PageMaker including versions of Lorem Ipsum.</span> <u onclick="myFunction()" id="myBtn" style="color:#4EA971">Lebih Banyak</u></p>
            <hr>
