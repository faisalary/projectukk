                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row card-header" style="background-color: #FFFFFF; padding:0px;">
                                ...
                                <div class="col-7">
                                    <h5 class="mb-1"
                                        style="text-align: left !important; font-size: 20px; -webkit-line-clamp: 2;text-overflow: ellipsis; overflow: hidden; display: -webkit-box; -webkit-box-orient: vertical; word-break: break-word;">
                                        Back End Developer</h5>
                                    <p style="text-align: left !important; font-size:15px; margin-bottom: 0px;">PT Wings
                                        Surya</p>
                                </div>
                                <div class="col-2">
                                    <!-- <img src="{{ asset('front/assets/img/bookmark.svg') }}" onclick="changeImage(this)" /> -->

                                    <img src="{{ asset('front/assets/img/bookmark.svg') }}" class="getImage"
                                        onclick="imagefun()">
                                </div>
                            </div>
                            <div class="border"></div>
                            <div class="map-pin mt-3 mb-3"><i class="ti ti-map-pin" style="margin-right: 10px"></i>Jakarta
                                Selatan, Indonesis</div>
                            <div class="currency-dollar mb-3" style="margin-left: -1px; margin-right: 10px"><i
                                    class="ti ti-currency-dollar" style="margin-right: 10px"></i>IDR 4.300.000 - 5.500.000
                            </div>
                            <div class="briefcase mb-3" style="margin-left: 1px;"><i class="ti ti-briefcase"
                                    style="margin-right: 10px"></i>2 Semester</div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="location" style="margin-left: 2px;"><i class="fas fa-user-friends"
                                            style="margin-right: 10px"></i>2 Semester</div>
                                </div>
