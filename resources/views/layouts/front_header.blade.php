    ...
    <div class="container-fluid" style="padding: 0!important;">
        ...
        <div class="main-box mx-4">
            ...
            <div class="logo-box mr-3">
                <div class="logo mr-3"> <img src="{{ asset('front/assets/img/logo.svg') }}" class="img-fluid"
                        alt=""><a href="{{ url('/') }}"></a></div>
            ...
            @if (!$user)
                ...
                <div class=" outer-box">
                    ...
                    <div class="btn-group">
                            ...
                            <div class="dropdown">
                                <button class="btn dropdown-toggle" type="button" data-toggle="dropdown">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="26"
                                        ...
                                        <ellipse cx="12" cy="13" rx="9" ry="9.73346"
                                            stroke="#23314B" stroke-width="1.28571" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M3.60059 9.75552H20.4006" stroke="#23314B" stroke-width="1.28571"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M3.60059 16.2445H20.4006" stroke="#23314B" stroke-width="1.28571"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M11.4997 3.26655C8.06261 9.22318 8.06261 16.7768 11.4997 22.7335"
                                            stroke="#23314B" stroke-width="1.28571" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M12.5 3.26655C15.9371 9.22318 15.9371 16.7768 12.5 22.7335"
                                            stroke="#23314B" stroke-width="1.28571" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                    IND
                        ...
                        <a href="{{ route('register') }}"
                            style="text-decoration: none; color:#23314B; font-weight: 500; font-size: 15px;">Untuk
                            Perusahaan</a>
                    </div>
                </div>
            @else
                <div class="outer-box">
                    ...
                    @if (
                        ($user && is_array($user->roles) && count($user->roles) > 0 && $user->roles[0]->name != 'applicant') ||
                            $user->profile)
                        <li class="nav-item dropdown" id="top-notification-dropdown">
                            <a class="nav-link" data-toggle="dropdown" href="#">
                                ...
                                @if (count($user->unreadNotifications) > 0)
                                    <span
                                        class="badge badge-warning navbar-badge">{{ count($user->unreadNotifications) }}</span>
                                @endif
                            </a>
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                ...
                                @if (count($user->unreadNotifications) > 0)
                                    <a id="mark-notification-read" href="javascript:void(0);"
                                        class="dropdown-item dropdown-footer">@lang('app.markNotificationRead') <i
                                            class="fa fa-check"></i></a>
                                @else
                                    <a href="javascript:void(0);"
                                        class="dropdown-item dropdown-footer">@lang('messages.notificationNotFound') </a>
                                @endif
                            </div>
                        </li>
                    @endif
                        ...
                        <ul class="navigation p-0 m-0" id="navbar">
                            <li class="current dropdown p-0 m-0">
                                <a class="image-container nav-link waves-effect waves-light"
                                    ...
                                    <div class="image">
                                        <img src="{{ $user->profile_image_url }}" style="vertical-align:unset;"
                                            alt="User Image">
                                    </div>
                                    <div style="line-height: normal;">
                                        ...
                                        @if ($user && is_array($user->roles) && count($user->roles) > 0 && $user->roles[0]->name != 'applicant')
                                            <span class="text-muted"
                                                style="font-size: 12px;">{{ $user->roles[0]->name }}</span>
                                        @endif
                                    </div>
                                </a>
                                <ul>
                                    ...
                                    @if (isset($user) && isset($user->roles) && count($user->roles) > 0 && $user->roles[0]->name == 'applicant')
                                        @if ($user->profile)
                                            <li><a href="{{ route('profile.index') }}"
                                                    class="{{ request()->is('profile') ? 'active' : '' }}">My
                                                    Profile</a></li>
                                            <li><a href="{{ route('application.index') }}"
                                                    class="{{ request()->is('profile/applications') ? 'active' : '' }}">My
                                                    Applications</a></li>
                                        @else
                                            <li><a href="{{ route('profile.setup') }}"
                                                    class="{{ request()->is('profile/setup') ? 'active' : '' }}">Setup
                                                    Profile</a></li>
                                        @endif
                                    @else
