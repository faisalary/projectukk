<html>
  ...
  <p style="color: #222;">Selamat anda berhak melanjutkan proses <span style="color: #222; font-weight: 600;">Seleksi Tahap 1</span> pada <span style="color: #222; font-weight: 600;">PT. ABC</span> dengan posisi <span style="color: #222; font-weight: 600;">UI/UX Designer.</span> Pastikan untuk menyusun portofolio dan mempersiapkan diri anda untuk menghadapi tahap berikutnya.</p>
  
  <p style="color: #4B465C;">Berikut File Jadwal <span style="color: #222; font-weight: 600;">Seleksi Tahap 1:</span></p>

  <p style="color: #4B465C;">Jika memiliki kendala atau hambatan untuk <span style="color: #222; font-weight: 600;">Seleksi Tahap 1</span> silahkan hubungi penanggungjawab seleksi  dibawah ini : </p>
