<div class="modal fade modals" id="largeModal">
    <div class="modal-dialog modal-lg  modal-dialog-centered">
        ...
        <div class="modal-content">
          ...
          <form action="{{ route('ganti.update') }}" method="POST" class="modal-body">
            ...
            <div style="display:grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap:2rem;">
                <div>
                    ...
                    <br>
                    <input type="text" name="nohpdosen" id="changeNoTelp" placeholder="Masukkan No Telp" style="width: 100%;  height: 3rem;" class="px-2 rounded border">
                </div>
                <div>
                    ...
                    <br>
                    <input type="text" name="emaildosen" id="changeEmail" placeholder="Masukkan Email" style="width: 100%;  height: 3rem;" class="px-2 rounded border">
                </div>
            </div>
            ...
            <form action="{{ route('ganti.update') }}" method="POST" class="modal-body">
              ...
              <div style="display: grid; grid-template-columns: repeat(1, minmax(0, 1fr)); gap: 1rem;">
                  <div>
                      ...
                      <br>
                      <input type="text" name="namapeg" id="changeNamaPegawai" placeholder="Masukkan Nama Pegawai" style="width: 100%; height: 3rem;" class="px-2 rounded border">
                  </div>
                  <div>
                      ...
                      <br>
                      <input type="text" name="nohppeg" id="changeNoTelp" placeholder="Masukan No Telp" style="width: 100%;  height: 3rem;" class="px-2 rounded border">
                  </div>
                  <div>
                      <label for="changeEmail">Email
                        <span class="text-danger">*</span>
                      ...
                      <br>
                      <input type="text" name="emailpeg" id="changeEmail" placeholder="Masukkan Email" style="width: 100%;  height: 3rem;" class="px-2 rounded border">
                  </div>
                  <div>
            ...
            <form action="{{ route('ganti.update') }}" method="POST" class="modal-body">
              ...
              <div style="display: grid; grid-template-columns: repeat(1, minmax(0, 1fr)); gap: 1rem;">
                  <div>
                      ...
                      <br>
                      <input type="text" name="email"id="changeEmail" placeholder="Masukkan Email" style="width: 100%; height: 3rem;" class="px-2 rounded border">
                  </div>
                  <div>
                      ...
                      <br>
                      <input type="text" name="username" id="changeUsername" placeholder="Masukan Username" style="width: 100%;  height: 3rem;" class="px-2 rounded border">
                  </div>
              </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-primary">Simpan</button>
