@if ($pendaftar->where('konfirmasi_status', 1)->count() == 0)
...
<div class="card mt-2">
    <div class="card-body">
        <div class="alert alert-danger alert-dismissible" role="alert">
            Anda dapat mengambil tawaran kembali sebelum batas konfirmasi penerimaan
            tanggal
        ...
        @if (Carbon\Carbon::now()->lessThan($item->lowongan_magang->date_confirm_closing))
        <div class="text-left">
