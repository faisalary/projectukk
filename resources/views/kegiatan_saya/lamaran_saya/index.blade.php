...
@section('page_style')
    ...
    <link rel="stylesheet"
        href="{{ asset('app-assets/vendor/libs/datatables-fixedcolumns-bs5/fixedcolumns.bootstrap5.css') }}" />
    <link rel="stylesheet"
        href="{{ asset('app-assets/vendor/libs/datatables-fixedheader-bs5/fixedheader.bootstrap5.css') }}" />
...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row ps-3">
            <ul class="nav nav-pills mb-3 " role="tablist" id="mandiritab">
                <li class="nav-item" style="font-size: 15px;">
                    <button type="button" id="fakultas" target="1" class="nav-link active" role="tab"
                        data-bs-toggle="tab" data-bs-target="#navs-pills-justified-magang-fakultas"
                        aria-controls="navs-pills-justified-magang-fakultas" aria-selected="false">
                        Magang Fakultas
                    </button>
                </li>
                <li class="nav-item" style="font-size: 15px;">
                    <a class="nav-link" role="tab" data-bs-toggle="tab" href="#navs-pills-justified-magang-mandiri"
                        aria-controls="navs-pills-justified-magang-mandiri" aria-selected="true">
                        Magang Mandiri
                    </a>
                </li>
            </ul>
