...
<div class="sec-title ms-5 me-5 mt-4 mb-3">
...
<div class="col-md-3 col-12 ms-5 mt-2 mb-2 d-flex align-items-center justify-content-between">
    ...
    <div class="card-body"> <a href="/kegiatan_saya/lamaran_saya/status" style="color:#4B4B4B">
        <div class="row">
          ...
          <div class="col-10 d-flex justify-content-between">
            ...
            <div>
              <span class="badge bg-label-danger me-1 text-end">Ditolak</span>
            </div>
          </div>
        </div>
        <div class="text-left">
    ...
    <div class="card-body"> <a href="/kegiatan_saya/lamaran_saya/status" style="color:#4B4B4B">
        <div class="row">
          ...
          <div class="col-10 d-flex justify-content-between">
            ...
            <div>
              <span class="badge bg-label-success me-1 text-end">Diterima</span>
            </div>
          </div>
        </div>
        <div class="text-left">
