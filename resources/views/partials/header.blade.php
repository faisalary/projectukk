...
<head>
<meta charset="utf-8">
<title>Superio | Just another HTML Template | Home Page 04</title>
    ...
    <header class="main-header header-style-two alternate">
        <div class="auto-container">
            ...
            <div class="main-box">
                ...
                <div class="nav-outer">
                    <div class="logo-box">
                        <div class="logo"><a href="index.html"><img src="{{ asset('front/assets/landing/images/logo-2.svg')}}" alt="" title=""></a></div>
                    </div>
