                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li
                                ...
                                <a href="/master_universitas" class="menu-link">
                            ...
                            <li
                                ...
                                <a href="/master_fakultas" class="menu-link">
                                    <div data-i18n="Master Fakultas">Master Fakultas</div>
                                </a>
                            </li>
                            <li
                                class="menu-item @if (!empty($active_menu)) {{ $active_menu == 'master_prodi' ? 'active' : '' }} @endif">
