        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4" style="justify-content: space-between; !important">
                    <div class="flex-shrink-0 mt-n5 mx-sm-0 mx-auto ms-0 ms-sm-5">
                        ...
                        <div style="margin-top: 24px;">
                            ...
                            <ul
                            class="list-inline mb-0 align-items-center gap-2"
                            >
                ...
                <div class="d-flex ms-0 ms-sm-5 mx-sm-5" style="justify-content: space-between;">
                    <div style="border: 1px solid #D3D6DB; border-radius: 6px; padding: 20px; margin-right: 20px ">
                        <div class="d-flex">
                    ...
                    <div style="border: 1px solid #D3D6DB; border-radius: 6px; padding: 20px; margin-bottom: 30px; !important">
                        <div class="d-flex">
