...
>
  ...
  <body>
    <div class="authentication-wrapper authentication-cover authentication-bg" style="background-image: url({{asset('assets/images/background/logbook_mhs/bg_page.png')}}); background-repeat: no-repeat; background-size: cover;  padding-bottom: 1rem;">
      <div class="authentication-inner text-center">
        <img alt="auth-login-cover" class="img-fluid" width="600" src="{{ asset('assets/images/background/logbook_mhs/asset.png') }}" alt="Login" />
        <div class="text-center">
          <h3>Anda belum mengikuti program magang apapun</h3>
          <a href="{{ route('apply_lowongan') }}" class="btn btn-primary">Lihat Lowongan</a>
        </div>
      </div>
    </div>
</body>
