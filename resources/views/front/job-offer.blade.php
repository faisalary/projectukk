...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="column col-lg-12 col-md-12 col-sm-12 mt-5" id="">
                <!--Order Box-->
                <div class="row gap-y">
                    <div class="col-6">
                    <div class="sidebar-widget">
                        <!-- Job Overview -->
                        <h4 class="widget-title">@lang('app.candidate') @lang('app.detail')</h4>
                        <div class="widget-content">
                            <ul class="job-overview">
                                <li>
                                    {{-- <i class="icon icon-user-2"></i> --}}
                                    <h6>@lang('app.name')</h6>
                                    <p>{{ ucwords($offer->applications->user->name) }}</p>
                                </li>
                                <li>
                                    {{-- <i class="icon icon-letter"></i> --}}
                                    <h6>@lang('app.email')</h6>
                                    <p>{{ $offer->applications->email }}</p>
                                </li>
                                <li>
                ...
                <div class="col-6">
                    <div class="sidebar-widget">
                        <!-- Job Overview -->
                        <h4 class="widget-title">@lang('app.offer') @lang('app.detail')</h4>
                        <div class="widget-content">
                            <ul class="job-overview">
                                <li>
                                    {{-- <i class="icon icon-user-2"></i> --}}
                                ...
                                <li>
                                    ...
                                    <p>{{ number_format($offer->salary_offered) }}</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="sidebar-widget">
                            <h4 class="widget-title">@lang('app.job') @lang('app.detail')</h4>
                            <div class="widget-content">    
                                <ul class="job-overview">
                                    <li>                        
            ...
            <div class="col-md-12 ">
                <div class="row gap-y sidebar-widget">
