...
<div class="container-xxl flex-grow-1 container-p-y">
    <a href="/lowongan-pekerjaan-tersimpan" type="button" class="btn btn-outline-success mt-4 mb-3 waves-effect">
        ...
        <div class="card" style="padding: 50px 30px; width: 100%;">
            <div class="card-body d-flex flex-row justify-content-between" style=" border-bottom: 1px solid #D3D6DB;  !important">
                <div class="">
                    ...
                    <div class="d-flex" style="margin-top: 40px; font-size: 16px; !important">
