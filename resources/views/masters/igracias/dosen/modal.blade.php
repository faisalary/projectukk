    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header text-center d-block">
                <h5 class="modal-title capitalize-title" id="modal-title">Tambah Dosen</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="default-form" action="{{ route('igracias.dosen.store') }}" function-callback="afterAction">
                @csrf
                    ...
                    <div class="row">
                        <div class="col mb-2 form-group">
                            ...
                            <input input type="text"
                                ...
                                id="nohpdosen" name="nohpdosen" class="form-control" placeholder="No Telepon" />
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="row">
...
<div class="modal fade modals" id="modal-dosen-import" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            ...
            <form class="default-form" id="" name="import" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <a href="{{ asset('template-excel/Template_Import_Dosen.xlsx') }}" class="btn btn-primary w-100" id="download-template">Download Template</a>
                        </div>
                    </div>
