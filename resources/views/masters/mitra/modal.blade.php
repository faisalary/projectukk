                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-2 form-input">
                            ...
                            <input type="text" id="mitra" onkeyup="this.value = this.value.replace(/[^a-zA-Z\s]+/gi, '');" name="namaindustri" class="form-control" placeholder="Nama Mitra" />
                    ...
                    <div class="row">
                        <div class="col mb-2 form-input">
                            ...
                            <input type="text" id="telp" name="notelepon" class="form-control" placeholder="No Telepon" />
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col mb-2 form-input">
                            ...
                            <textarea class="form-control" id="alamat" name="alamatindustri" placeholder="Alamat"></textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="row">
