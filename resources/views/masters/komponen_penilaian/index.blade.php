...
<div class="row">
    ...
    <div class="col-md-6 col-12 text-end">
        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTambahKomponen">Tambah Komponen Penilaian</button>
    </div>
</div>
<div class="row mt-2">
    <div class="col-12">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header text-center d-block">
                <h5 class="modal-title" id="modalTambahKomponen">Tambah Komponen Penilaian</h5>
                ...
                <form class="form-repeater">
                    ...
                    <div data-repeater-item="">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <input type="text" id="form-repeater-1-1" class="form-control" placeholder="Nama Komponen">
                        </div>
                        <div class="col-md-4 col-15" style="margin-right: -1rem; margin-left: -1rem;">
                            ...
                            <input type="text" id="form-repeater-1-2" class="form-control" placeholder="Bobot Penilaian">
                        </div>
                        <div class="col-md-3 col-12">
                            <label class="form-label" for="form-repeater-1-2">Dinilai Oleh</label>
                            <input type="text" id="form-repeater-1-2" class="form-control" placeholder="Dinilai Oleh">
                        </div>
...
<div class="modal fade" id="modalEditKomponen" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header text-center d-block">
                <h5 class="modal-title" id="modalEditKomponen">Edit Komponen Penilaian</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="form-repeater">
...
<script>
    var jsonData = [{
            ...
            "bobot": "20%",
            "total bobot": "",
            "status": "<a data-bs-toggle='modal' data-bs-target='#modalEditKomponen' class='btn-icon'><span class='badge bg-label-success'>Aktif</span></a>",
            "aksi": "<a data-bs-toggle='modal' data-bs-target='#modalTambahKomponen' class='btn-icon text-warning waves-effect waves-light'><i class='tf-icons ti ti-edit' ></i></a> <a onclick = deactive($(this))  class='btn-icon text-danger waves-effect waves-light'><i class='far fa-check-circle text-success'></i></a>"
        },
        {
            "nomor": "",
            "jenis magang": "",
